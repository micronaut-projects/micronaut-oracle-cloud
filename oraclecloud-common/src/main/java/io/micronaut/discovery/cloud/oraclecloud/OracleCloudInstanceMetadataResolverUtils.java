 ...
 * that uses micronaut-serialization and doesn't require jackson-databind dependency.
 *
 * @author Dean Wette
 * @since 3.0.0
 */
@Internal
final class OracleCloudInstanceMetadataResolverUtils {

    private OracleCloudInstanceMetadataResolverUtils() {
    }
