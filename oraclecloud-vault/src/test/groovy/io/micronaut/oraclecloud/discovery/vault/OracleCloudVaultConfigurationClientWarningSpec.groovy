...
@MicronautTest(contextBuilder = OracleCloudVaultConfigurationClientWarningSpec.MyContextBuilder)
class OracleCloudVaultConfigurationClientWarningSpec extends Specification {
    ...
    void 'legacy bootstrap client remains resolvable and returns property sources when importer is absent'() {
        given:
