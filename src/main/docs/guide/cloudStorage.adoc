...
For more information, see the https://micronaut-projects.github.io/micronaut-object-storage/latest/guide/#oracleCloud[Micronaut Object Storage Oracle Cloud support] documentation.
