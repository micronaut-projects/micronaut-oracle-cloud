...
Optionally, to use the OCI SDK module from within your function, include the `micronaut-oraclecloud-sdk`:

dependency:io.micronaut.oci:micronaut-oraclecloud-sdk[]
