...
dependency:io.micronaut.oraclecloud:micronaut-oraclecloud-sdk[version={oci3Version}]
...
dependency:com.oracle.oci.sdk:oci-java-sdk-objectstorage[version={oci3Version}]
